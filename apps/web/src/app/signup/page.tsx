...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("An error occurred during sign up. Check console.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleGoogleSignUp = async () => {
    toast.error("Google sign up is disabled for now.");
  };
      ...
      <main className="w-full max-w-[440px] relative z-10 my-auto shrink-0">
        ...
        <div className="glass-card ai-glow rounded-xl p-10 flex flex-col gap-8">
          <div className="flex flex-col gap-1">
            ...
            <p className="font-body-md text-body-md text-outline">Fill in the details below to create an account.</p>
          </div>
